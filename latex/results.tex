...
pairs across 12 seasons. Figure~\ref{fig:theta_vs_crlb}~(left) shows
$\hat{\theta}$ against $\sqrt{\text{CRLB}}$, the theoretical lower
...
fall in the non-significant region. Therefore, we observe the lack of
statistical power in identifying $\theta > 0$.

It is also interesting to observe the relatively uniform distribution
of $\theta$'s in $[0, 0.5]$. This implies that 
