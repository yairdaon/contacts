...
Therefore:
\begin{align*}
[\mathbf{J}]_{kl} &= \frac{1}{\sigma^4} \sum_{t=0}^{T-1}\sum_{i=1}^{2} \sigma^2 \frac{\partial \mu_i(t)}{\partial \phi_k}\frac{\partial \mu_i(t)}{\partial \phi_l} \\
&= \frac{1}{\sigma^2} \sum_{t=0}^{T-1}\sum_{i=1}^{2} \frac{\partial \mu_i(t)}{\partial \phi_k}\frac{\partial \mu_i(t)}{\partial \phi_l}
\end{align*}
