...
estimate and is considerably cheaper to compute.
...
\end{align*}
where $\bar y_{t} = \sum_{S} y_{S, t} / 47$ is the lag-one national
...
Two mechanisms can produce a bilateral improvement of (state) over
(univariate): (i) directed predictability, in which $B$'s past
actually forecasts $A$'s future beyond $A$'s own past and shared
seasonality; or (ii) a shared national forcing, in which $B$'s lagged
